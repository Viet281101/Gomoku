...
export class Toolbar {
	...
	private createButtons() {
		return [
			{ name: 'Tutorial', icon: '/gomoku/public/icons/question.png', action: () => this.togglePopup('tutorial'), x: 0, y: 0, width: 0, height: 0 },
			{ name: 'Settings', icon: '/gomoku/public/icons/setting.png', action: () => this.togglePopup('settings'), x: 0, y: 0, width: 0, height: 0 },
		];
	}
	...
	private addCloseIcon() {
		...
		closeIcon.src = '/gomoku/public/icons/close.png';
